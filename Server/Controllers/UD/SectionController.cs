...
namespace DOOR.Server.Controllers.UD
{
    ...
    {
        public SectionController(DOOROracleContext DBcontext, OraTransMsgs _OraTransMsgs) : base(DBcontext, _OraTransMsgs)
        {
        }
        ...
        public async Task<IActionResult> PutSection([FromBody] SectionDTO _SectionDTO)
        {
            ...
            {
                Section? c = await _context.Sections
                    .Where(x => x.SectionNo == _SectionDTO.SectionNo)
                    .FirstOrDefaultAsync();
        ...
        public async Task<IActionResult> DeleteSection(int _SectionId)
        {
            try
            {
                Section? c = await _context.Sections.Where(x => x.SectionId == _SectionId)
                    .FirstOrDefaultAsync();
